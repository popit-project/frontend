...
<div className="pt-10 pb-10">
  <p className="pb-5 pl-2 font-bold text-xl">내 주변 인기 스토어 &gt;</p>
  <div>
      ...
      <div key={popup.id} className="flex p-2 border-b">
        ...
        <div className="ml-4 sm:ml-6">
          <div className="text-left">
            <h3 className="font-bold text-lg sm:text-xl md:text-2xl">{popup.name}</h3>
            <p className="text-sm text-gray-500">{popup.address}</p>
            <p className="text-sm text-gray-500">{popup.period}</p>
          </div>
        </div>
