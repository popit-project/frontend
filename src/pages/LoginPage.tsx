        ...
        <div className="my-0 mx-auto mb-[10rem]">
          <div className="loginForm w-full">
            <form onSubmit={loginRequest}>
              <input
                ...
                name="userId"
                onChange={changeData}
                className="input input-success w-full max-w-xs block mb-[3rem] mt-[3rem] mx-auto border-indigo-500 hover:border-indigo-500 focus:outline-indigo-500"
              />
              <input
                type="password"
                placeholder="비밀번호"
          ...
          <div className="w-screen flex justify-center">
            <div className="flex justify-center mb-[5rem] min-w-3xl">
              ...
              <img
                className="w-12 h-12 mr-[5.5rem] ml-[5.5rem]"
                src={naver}
              ></img>
